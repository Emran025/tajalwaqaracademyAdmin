...
- **FR-1.4.1** يجب أن يتمكن المشرف من عرض الملف الشخصي الكامل للمعلم.
- **FR-1.4.2** يجب أن يتمكن المشرف من مراجعة طلبات المعلمين والموافقة عليها أو رفضها.

#### 3.1.2 إدارة الطلاب

- **FR-1.5** يجب أن يتمكن المشرف من مراجعة وقبول أو رفض الطلبات المقدمة من الطلاب.
...
- **FR-1.8.1** يجب أن يستطيع المشرف إضافة وتعديل خطط الحفظ والمراجعة للطلاب.
- **FR-1.8.2** يجب أن يتمكن المشرف من متابعة أداء الطلاب بشكل مستمر من خلال واجهة مخصصة.
- **FR-1.8.3** يجب أن يتمكن المشرف من إنشاء وعرض تقارير متابعة دورية للطلاب.
...
- **FR-1.13** يجب أن يدعم التطبيق رفع ملفات CSV لإدخال بيانات جماعية للطلاب أو المعلمين، شريطة توافق التنسيق مع القالب المعتمد.
...
- **FR-1.17** يجب أن يستطيع تصدير أي تقرير بصيغتي PDF وCSV.
...
- **FR-2.2** يجب أن يتلقى المعلم رسالة اخطار على التطبيق عند تعديل بياناته واخطار في حال جلسة تسجيل دخول جديدة، و رسالة Email عند إعادة تعيين كلمة مروره.
...
### Use Case 6: مراجعة طلبات التسجيل (المشرف)
...
### Use Case 7: تعديل بيانات الطالب أو المعلم
...
### Use Case 8: تصدير التقارير والإحصاءات
...
### Use Case 9: تنبيه المعلم بتجاوز عدد غيابات الطالب
...
### Use Case 10: أرشفة الحلقات غير النشطة
...
### Use Case 11: استعراض سجل الأداء لطالب
...
### Use Case 12: رفع بيانات الطلاب/المعلمين من ملف CSV
...
### Use Case 13: إرسال ملاحظات من المعلم للمشرف

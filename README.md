...
نظام "أكاديمية تاج الوقار لتعليم القرآن الكريم" هو نظام إلكتروني متكامل مكوّن من تطبيق محمول (Mobile Applicant) موجه للمعلمين والمشرفين، ومنصة ويب (Web Platform) تُستخدم لتسجيل الطلبة والمعلمين الجديد. يهدف النظام إلى رقمنة وتسهيل إدارة ومتابعة الحلقات القرآنية، من خلال توفير آليات منظمة لتسجيل الأداء اليومي والشهري للطلاب، وتوزيعهم على المعلمين، وتتبع تقدمهم في الحفظ والمراجعة، وإصدار تقارير دورية دقيقة وشاملة للإدارة.
...
| **API** (Applicant Programming Interface)     | واجهة برمجية تُمكّن من تبادل البيانات بين الخادم والتطبيق أو الموقع.                                 |
...
lib/
│
├── core/                          # أدوات النظام العامة التي لا تتبع ميزة محددة
│   ├── error/                     # تعريف الأخطاء العامة مثل ServerFailure، CacheFailure
│   ├── network/                   # إعداد Dio أو Http client مشترك
│   ├── usecases/                  # حالات استخدام مجردة يمكن مشاركتها
│   ├── utils/                     # أدوات مساعدة عامة (DateFormatter، Validators...)
│   ├── constants/                 # ثوابت (API paths، ألوان، روابط، إلخ)
│   └── base/                      # Base classes مثل BaseBloc, BaseState
│
├── shared/                        # مكونات UI المشتركة
│   ├── widgets/                   # مثل CustomButton، AppTextField
│   ├── themes/                    # ThemeData وStyle constants
│   └── extensions/                # Extensions على DateTime، String...
│
├── config/                        # الإعدادات العامة
│   ├── di/                        # الربط بين التبعيات عبر get_it أو injectable
│   ├── env/                       # ملفات البيئة (dev, prod)
│   └── localization/              # ملفات الترجمة
│
├── features/                      # كل ميزة مستقلة بكامل طبقاتها
│   ├── <feature_name>/
│   │   ├── data/
│   │   │   ├── models/
│   │   │   ├── datasources/      # API أو LocalStorage
│   │   │   └── repositories_impl/
│   │   ├── domain/
│   │   │   ├── entities/
│   │   │   ├── repositories/     # Abstraction Interfaces
│   │   │   └── usecases/
│   │   ├── presentation/
│   │   │   ├── bloc/             # Bloc/Cubit وStates وEvents
│   │   │   ├── ui/               # خاص بالواجهات
│   │   │   │   ├── screens/      # مثل logIn_page.dart
│   │   │   │   └── widgets/      # Widgets خاصة بهذه الميزة
│   │   └── feature_module.dart   # نقطة الدخول للميزة (للتجميع أو التصدير)
│
│   └── ...(مزايا أخرى بنفس الهيكل)
│
├── routes/
│   └── app_router.dart           # إدارة التنقل باستخدام AutoRoute مثلاً
│
└── main.dart                     # نقطة التشغيل، تشمل تهيئة DI وRouter وLocalization

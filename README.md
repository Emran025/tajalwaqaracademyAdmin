...
#### 3.1.5 نظام التحليلات المتقدم

- **FR-1.22** يجب أن يوفر النظام نظام تحليلات متقدم لاستبدال "التقارير الشهرية" القديمة.
- **FR-1.23** يجب أن يتضمن النظام الجديد مخططات قابلة للتصفية حسب الوقت، وتصورات للتقدم، ومقاييس للأداء، ومخططات لتحليل الأخطاء.
- **FR-1.24** يجب أن تكون جميع المخططات والتحليلات متوافقة مع ما هو موضح في ملف: `tajalwaqaracademy/تحليل أكاديمي وتقني للمخططات البيانية المقترحة لنظام إدارة الحلقات القرآنية.md`.
...
#### 3.2.5 المصحف التفاعلي (Interactive Mushaf)

- **FR-2.22** يجب أن يتمكن الطالب من الإبلاغ عن الأخطاء وتدوينها والاحتفاظ بالعلامات الملونة أو المظللة كما لو كان لكل طالب مصحف خاص به.
- **FR-2.23** يجب أن يوفر المصحف التفاعلي نظام تنقل تلقائي يتيح الانتقال بين الصفحات بناءً على مهام الحفظ وجلسات المراجعة وتسلسل التلاوة وحفظ مسودات تسجيلات الطلاب.

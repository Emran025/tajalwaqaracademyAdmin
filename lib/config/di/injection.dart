...
import '../../features/HalaqasManagement/domain/usecases/get_halaqa_by_id.dart';
import '../../features/HalaqasManagement/domain/usecases/get_halaqas.dart';
...
abstract class BlocModule {
  ...
  /// Provides the [HalaqaBloc] and immediately dispatches [FetchAllHalaqasEvent]
  /// to pre-fetch data.
  @factoryMethod
  HalaqaBloc halaqaBloc(
    WatchHalaqasUseCase watchHalaqas,
    FetchMoreHalaqasUseCase fetchMoreHalaqas,
    FetchFilteredHalaqasUseCase fetchFilteredHalaqas,
    UpsertHalaqa upsertHalaqa,
    DeleteHalaqaUseCase deleteHalaqa,
    GetHalaqaById getHalaqaById,
    SetHalaqaStatusUseCase setHalaqaStatus,
  ) {
    return HalaqaBloc(
      watchHalaqas: watchHalaqas,
      fetchMoreHalaqas: fetchMoreHalaqas,
      fetchFilteredHalaqas: fetchFilteredHalaqas,
      upsertHalaqa: upsertHalaqa,
      deleteHalaqa: deleteHalaqa,
      getHalaqaById: getHalaqaById,
      setHalaqaStatus: setHalaqaStatus,
    )..add(const WatchHalaqasStarted());
  }
  ...
  /// Provides the [SupervisorBloc] and immediately dispatches [SessionStarted]
  /// to pre-fetch data.
  @factoryMethod

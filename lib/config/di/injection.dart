...
import '../../features/supervisor_dashboard/presentation/bloc/supervisor_timeline_bloc.dart';
...
abstract class BlocModule {
  ...
  /// Provides the [SupervisorTimelineBloc] and immediately dispatches [SessionStarted]
  /// to pre-fetch data.
  @factoryMethod
  SupervisorTimelineBloc timelineBloc(
    GetTimelineUseCase getTimelineUseCase,
    GetDateRangeUseCase getDateRangeUseCase,
    GetEntitiesCountsUseCase getEntitiesCountsUseCase,
  ) {
    return SupervisorTimelineBloc(
      getTimelineUseCase: getTimelineUseCase,
      getDateRangeUseCase: getDateRangeUseCase,
      getEntitiesCountsUseCase: getEntitiesCountsUseCase,
    );

...
class SettingsRemoteDataSourceImpl implements SettingsRemoteDataSource {
  ...
  Future<UserProfileModel> getUserProfile() async {
    ...
    final responseJson = await _api.get(EndPoint.userProfile);
    ...
    return UserProfileModel.fromJson(responseJson as Map<String, dynamic>);
  }
  ...
  Future<PrivacyPolicyModel> getLatestPolicy() async {
    ...
    try {
      ...
      return PrivacyPolicyModel.fromJson(responseJson as Map<String, dynamic>);
      ...
      "sections": [
        {
          ...
          "content": "This policy, served from a mock data source, outlines our data principles."
        },
        {
          "title": "Remote: Data We Collect (Mocked)",
          "content": "During development, we simulate the collection of essential data for functionality."
        }
      ],
      "changelog": "This version was served by the active placeholder in the remote data source.",

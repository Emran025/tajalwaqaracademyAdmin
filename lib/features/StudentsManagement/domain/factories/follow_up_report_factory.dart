...
import '../../presentation/view_models/planned_detail_entity.dart';
import '../../presentation/view_models/actual_progress_entity.dart';
...
import '../../presentation/view_models/follow_up_report_entity.dart';
import '../../presentation/view_models/follow_up_report_detail_entity.dart';
import '../../presentation/view_models/student_summary_entity.dart';
import '../../presentation/view_models/student_performance_metrics_entity.dart';

/// فئة "مصنع" مسؤولة عن منطق العمل لإنشاء تقارير المتابعة.
///
/// تقوم هذه الفئة بتنسيق عملية تحويل البيانات الخام (الخطة والتتبع) إلى
/// حزمة تقرير منظمة وقابلة للاستخدام، مع حساب جميع المقاييس والملخصات اللازمة.
class FollowUpReportFactory {
  // --- 1. تعريف قواعد العمل كثوابت لسهولة الصيانة ---

  /// عدد الصفحات في الجزء الواحد.
  static const double _pagesPerJuz = 20.0;

  /// عدد الصفحات في الحزب الواحد.
  ...
  /// عتبة اعتبار الطالب "متأخراً" (بالصفحات).
  static const double _behindStatusThreshold = -5.0;

  /// عتبة اعتبار الطالب "متقدماً" (بالصفحات).
  ...
  FollowUpReportBundleEntity create({
    ...
    // الخطوة الثالثة: تجميع النتائج في الحزمة النهائية.
